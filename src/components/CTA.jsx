      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-400 mb-8 reveal">
            We Build Them. If you're spending KES 30000/month on paid ads and your biggest bottleneck is creative volume, quality, or both we should talk. We'll build your entire creative engine, staff it with operators who've been in your seat, and tie our compensation directly to performance.
          </p>
